...
export default function FloorView() {
  ...
  // Compute per-floor min/max so the color scale always spans the full
  // red→blue range: the hottest room on this floor is pure red, coolest
  // is pure blue. For floors with only one room, add a ±1 °C buffer so it
  // renders a mid-range color instead of solid blue.
